...
<div class="container">
    <div class="ui modal">
        <div class="header" style="text-align: center;">비밀번호 찾기</div>
        <form>
            <br/><br/>
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <button type="button" id="btn-send-code-byPassword" class="ui button">인증번호 전송</button>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <button type="button" id="btn-verify-code-byPassword" class="ui button">인증번호 확인</button>
                </div>
                <span id="span-verify"></span>
            </div>
            <span id="send-tempPassword">인증 완료 시, 링크를 클릭하면 귀하의 이메일로 임시 비밀번호가 발송됩니다.</span>
            <br/><br/><br/><br/>
        </form>
        <br/>
...
<style>
    ...
    /* 마우스를 올렸을 때의 스타일 */
    #send-tempPassword:hover {
        color: royalblue; /* 마우스를 올렸을 때 색상 변경 */
    }

    /* 클릭했을 때의 스타일 */
    #send-tempPassword:active {
